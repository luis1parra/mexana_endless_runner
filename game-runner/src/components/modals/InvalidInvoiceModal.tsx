  ...
  return (
    <div className="fixed inset-0 z-[140] flex items-center justify-center bg-black/80 px-4 py-8">
      <div
        ...
        className="relative w-full max-w-[666px] rounded-[32px] bg-[var(--cpdblue)] mx-5 px-8 py-15 lg:px-15 lg:py-15 text-center text-white shadow-[0_45px_90px_rgba(12,35,106,0.45)]"
      >
        {/* {onClose && (
          <button
            type="button"
        ...
        <h2
          id={titleId}
          className="mt-5 text-[20px] font-extrabold leading-snug tracking-wide text-white md:text-[28px]"
        >
        ...
        <p
          id={descriptionId}
          className="mt-2 text-[17px] font-light text-center text-white leading-[1.1] md:text-[20px]"
        >
        ...
        <button
          ...
          className="cursor-pointer mt-7 inline-flex items-center justify-center rounded-full border border-white px-10 py-3 text-lg font-semibold text-white transition hover:bg-white/10"
        >
          Volver al inicio
        </button>
      </div>
